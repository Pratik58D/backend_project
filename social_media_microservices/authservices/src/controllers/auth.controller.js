...
import { validateLogin, validateUserRegistration } from "../utils/validation.js";
...
const refreshTokenUser = async (req, res) => {
    ...
    try {
        ...
        console.log(req.body,"refresh token")
        ...
        logger.error("refresh token controller error occured", error.message);
        res.status(500).json({
            success: false,
            message: "Internal server error",
        });
...
const logoutUser = async (req, res) => {
  ...
  try {
    ...
    return res.json({
     ...
     logger.error("logout controller error occured", error);
        res.status(500).json({
            success: false,
            message: "Internal server error",
        });
